...
public class DocB_db extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "DoctorB_db";
    private static final String TABLE_NAME = "DoctorB";
    ...
    public DocB_db(@Nullable Context context) {
