...
public class DocC_db extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "DoctorC_db";
    private static final String TABLE_NAME = "DoctorC";
    ...
    public DocC_db(@Nullable Context context) {
